...
export class MotionSensor extends Sensor
{
              ...
              protected readonly name: string)
  {
    super(platform, accessory, accessory.getService(name) ||
      accessory.addService(platform.Service.MotionSensor, name, platform.serviceUuid(name)));
  }
  ...
  {
    this.service.setCharacteristic(this.platform.Characteristic.MotionDetected, motionDetected);
  }
