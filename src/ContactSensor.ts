...
export class ContactSensor extends Sensor
{
              ...
              protected readonly name: string)
  {
    super(platform, accessory, accessory.getService(name) ||
      accessory.addService(platform.Service.ContactSensor, name, platform.serviceUuid(name)));
  }
  ...
  {
    this.service.updateCharacteristic(this.platform.Characteristic.ContactSensorState, detected ?
